package cloud.makeronbean.gmall.common.constant;
...
public class RedisConst {
    ...
    // 抢单消息主题
    public static final String SECKILL_TOPIC = "seckillpush";
    //用户锁定时间 单位：秒
    ...
    // 商品热度相关
    public static final String HOT_KEY = "hotScore";
    public static final String HOT_VALUE = "skuId:";
